...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ExecuteBA.executeBA(w1, b, 1, t, n, m, e, p, q, 0.05,0);
            ...
            double[][] w2 = { {-100, 100} };
            ExecuteBA.executeBA(w2, b, 6, t, n, m, e, p, q, 0.05, 1);
            ...
            ExecuteBA.executeBA(w3, b, 3, t, n, m, e, p, q, 0.05,2);
            ...
            double[][] w4 = { {-10, 10} };
            ExecuteBA.executeBA(w4, 10, 1, 1, 10, 10, 10, 10, 10, 0.05,0);
            ...
            ExecuteBA.executeBA(w2, b, 12, 3, 120, 20, 10, 20, 10, 0.05,1);
            ...
            ExecuteBA.executeBA(w6, b, 1, 3, n, m, e, p, q, 0.05,0);
            ...
            double[][] w7 = { {0, 0.0001} };
            ExecuteBA.executeBA(w7, b, 2, 5, n, m, e, p, q, 0.05,0);
            ...
            ExecuteBA.executeBA(w8, b, 4, 5, 200, 20, 10, 20, 10, 0.05,0);
            ...
            ExecuteBA.executeBA(w3, 10, 2, 3, 50, 50, 20, 20, 10, 0.05,2);
            ...
            ExecuteBA.executeBA(w2, 10, 4, 4, 100, 80, 40, 20, 10, 0.05,1);
            ...
            ExecuteBA.executeBA(w2, 10, 4, 4, 200, 20, 10, 20, 10, 0.05,1);
            ...
            ExecuteBA.executeBA(w1, 50, 2, 4, 200, 100, 50, 50, 50, 0.05,0);
            ...
            ExecuteBA.executeBA(w3, 1, 4, 3, 50, 10, 5, 5, 2, 0.05,2);
            ...
            ExecuteBA.executeBA(w1, 10, 1, 0, 50, 10, 10, 10, 10, 0.05,0);
            ...
            ExecuteBA.executeBA(w3, 5, 2, 50, 20, 10, 5, 5, 5, 0.05,2);
            ...
            ExecuteBA.executeBA(w2, 10, 7, 3, 140, 20, 10, 20, 10, 0.05,1);
            ...
            ExecuteBA.executeBA(w17, 10, 2, 3, 50, 10, 10, 10, 10, 0.05,0);
            ...
            ExecuteBA.executeBA(w18, 5, 2, 4, 20, 10, 5, 5, 5, 0.05,0);
            ...
            ExecuteBA.executeBA(w3, 10, 4, 3, 200, 20, 10, 20, 50, 0.05,2);
            ...
            ExecuteBA.executeBA(w20, 5, 4, 10, 100, 20, 10, 10, 10, 0.05,2);
            ...
            double[][] w21 = { {-50, 50} };
            ExecuteBA.executeBA(w21, 1, 16, 3, 64, 16, 8, 4, 4, 0.05,1);
            ...
            ExecuteBA.executeBA(w21, 5, 4, 4, 100, 0, 0, 0, 0, 0.05,0);
            ...
            ExecuteBA.executeBA(w21, 10, 4, 4, 50, 50, 50, 10, 10, 0.05,2);
            ...
            ExecuteBA.executeBA(w24, 5, 1, 2, 40, 10, 5, 5, 5, 0.05,0);
            ...
            ExecuteBA.executeBA(w3, 10, 2, 30, 50, 10, 5, 10, 10, 0.05,2);
            ...
            ExecuteBA.executeBA(w26, 20, 4, 3, 100, 20, 10, 20, 10, 0.05,1);
            ...
            ExecuteBA.executeBA(w1, 10, 2, 2, 50, 10, 5, 10, 10, 0.05,999);
            ...
            ExecuteBA.executeBA(w3, 20, 4, 200, 200, 20, 10, 20, 10, 0.05,2);
            ...
            double[][] w29 = { {-100, 100} };
            ExecuteBA.executeBA(w29, 100, 8, 5, 10000, 100, 50, 50, 50, 0.05,1);
            ...
            ExecuteBA.executeBA(w1, 50, 2, 10, 2000, 100, 50, 50, 50, 0.05,0);
            ...
            ExecuteBA.executeBA(w3, 2, 4, 20, 1000, 50, 20, 10, 10, 0.05,2);
            ...
            ExecuteBA.executeBA(w32, 25, 4, 50, 1000, 100, 20, 50, 20, 0.05,2);
